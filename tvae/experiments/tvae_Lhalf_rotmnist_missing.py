...
def main(args):
    ...
    name = f'TVAE_ROTMNIST_L=1/2_K=3_pix_{config["prob_missing_pixels"]}_data_{config["prob_missing_data"]}'
    ...
    masks = np.load(f"/home/clement/Documents/rvae/benchmark_VAE/examples/data/rotated_mnist/masks/mask_miss_data_{args.prob_missing_data}_miss_pixels_{args.prob_missing_pixels}.npz")
