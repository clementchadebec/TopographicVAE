...
def main():
    ...
    name = 'TVAE_COLORMNIST_L=1/2_K=3'
    ...
    data_test = DynBinarizedMNIST(torch.load(os.path.join('/home/clement/Documents/TopographicVAE/tvae/data/test_12_long_color_mnist.pt')))
